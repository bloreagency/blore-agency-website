...
import { Mail, Phone, Send, MessageCircle, Clock, Facebook, Twitter, Linkedin, Instagram, Loader2 } from "lucide-react"
...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSubmitStatus({ type: 'error', message: 'An unexpected error occurred. Please check your connection and try again.' })
    } finally {
    ...
    <div className="min-h-screen">
      ...
      <section className="pt-32 pb-20 px-4 bg-gradient-to-br from-purple-600 to-cyan-500">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 animate-fade-in-up">Let's Talk</h1>
          <p className="text-xl text-white/90 leading-relaxed animate-fade-in-up delay-200">
            Ready to bring your vision to life? We'd love to hear about your project and explore how we can help you
            achieve your digital goals. Get in touch with us today and let's start creating something amazing together!
          </p>
        </div>
      </section>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    >
                      ...
                      <option value="AI-Powered Marketing Tools">AI-Powered Marketing Tools</option>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600 text-lg leading-relaxed mb-8">
                  ...
                  Reach out through any of the channels below and let's start a conversation about your digital goals
              ...
              <div className="bg-gradient-to-br from-cyan-50 to-purple-50 p-6 rounded-2xl border border-cyan-100">
                ...
                <div className="space-y-2 text-gray-700">
                  ...
                  <p>
                    <strong>Phone:</strong> Monday - Friday, 9:00 AM - 6:00 PM (GMT+2)
                  </p>
                  <p>
